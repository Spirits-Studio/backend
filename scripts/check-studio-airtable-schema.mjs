...
const SCHEMA_SPEC = {
  ...
  orders: {
    envKey: "AIRTABLE_ORDERS_FULFILLMENT_TABLE_ID",
    tableName: "Orders & Fulfilment",
    fields: [
      { name: "Order ID", type: "singleLineText" },
      { name: "Customer", type: "multipleRecordLinks" },
      { name: "Saved Configuration", type: "multipleRecordLinks" },
      { name: "Order Status", type: "singleSelect" },
      { name: "Addresses", type: "multipleRecordLinks" },
      { name: "Config JSON", type: "multilineText" },
      { name: "Front Label", type: "multipleAttachments" },
      { name: "Preview Image", type: "multipleAttachments" },
      { name: "Creation Source", type: "singleSelect" },
    ],
  },
  addresses: {
    envKey: "AIRTABLE_ADDRESSES_TABLE_ID",
    tableName: "Addresses",
    fields: [
      { name: "Full Address", type: "singleLineText" },
      { name: "Customer", type: "multipleRecordLinks" },
      { name: "Orders & Fulfilment", type: "multipleRecordLinks" },
      { name: "First Name", type: "singleLineText" },
      { name: "Last Name", type: "singleLineText" },
      { name: "Shopify ID", type: "singleLineText" },
      { name: "Street Address 1", type: "singleLineText" },
      { name: "Street Address 2", type: "singleLineText" },
      { name: "Town / City", type: "singleLineText" },
